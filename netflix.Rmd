...
```{r movie_distr, message = FALSE, echo = FALSE}
data %>%
...
Como se puede observar, el dia de la semana en la cual se visiona la película no tiene efecto sobre tu puntuación.
...
Mientras que el día de la semana en que se puntuó la película no afectaba a la puntuación, aquí se observa que desde junio hasta final de año la puntuación de las películas es más generosa. Por tanto, el mes en el que se puntuó la película tiene un efecto sobre la puntuación.
...
A continuación se escogen las diez películas con mayor número de valoraciones y se representa mediante un gráfico de calor:
...
En el gráfico anterior se pueden observar 2 outliers, en concreto, en las películas "The pianist" y "Clueless". Ambas son puntuaciones dadas por un único usuario y restan información al conjunto del gráfico por ello se procede a su eliminación.
...
Ahora se puede observar con mejor precisión la distribución de las puntuaciones de las diez películas más valoradas.
