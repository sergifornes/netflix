...
nombres_pelis <- nombres_pelis %>% separate(X1,",",into =c("ID_film","Date","Title"), extra="merge", convert = TRUE)

nombres_pelis$Date <- ifelse(nombres_pelis$Date == "NULL", NA,nombres_pelis$Date)

# FALTA JUNTAR NOMBRES_PELIS Y DF Y DEJAR EL DATAFRAME BONITO
df_test <- df[10,]
inner_join(nombres_pelis, df_test)
