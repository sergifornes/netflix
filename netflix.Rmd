...
De cada uno de los archivos `combined_data_x.txt`, buscamos las valoraciones de las películas que analizaremos y las metemos en un data frame, especificando en cada observación cual es el ID de la película valorada.
...
Primero se genera una tabla con las 250 películas y sus valoraciones distribuidas desde 1999 hasta 2005.
...
Se ouede ver que las películas más antiguas están mejor valoradas que las más recientes, aunque esto puede ser debido a que son películas de calidad, ya que sino Netflix no las incluiría en su catálogo. Aun así, son pocas las películas antiguas y tienen pocas visualizaciones, por lo que la media de las puntuaciones podría estar sesgada. Anteriormente hemos visto que las películas entre 1980 y 1995 han sido muy valoradas, y aquí vemos una tendencia positiva en sus puntuaciones.
